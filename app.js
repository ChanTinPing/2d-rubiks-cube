...
const DIAGRAM_POINTS = {
  U: [
    [{ x: 382, y: 145 }, { x: 500, y: 118 }, { x: 618, y: 145 }],
    [{ x: 410, y: 205 }, { x: 500, y: 185 }, { x: 590, y: 205 }],
    [{ x: 440, y: 265 }, { x: 500, y: 245 }, { x: 560, y: 265 }],
  ],
  L: [
    [{ x: 120, y: 245 }, { x: 200, y: 220 }, { x: 280, y: 245 }],
    [{ x: 95, y: 335 }, { x: 190, y: 335 }, { x: 285, y: 335 }],
    [{ x: 120, y: 425 }, { x: 200, y: 450 }, { x: 280, y: 425 }],
  ],
  F: [
    [{ x: 535, y: 330 }, { x: 600, y: 315 }, { x: 670, y: 330 }],
    [{ x: 530, y: 405 }, { x: 600, y: 390 }, { x: 675, y: 405 }],
    [{ x: 535, y: 480 }, { x: 600, y: 505 }, { x: 665, y: 480 }],
  ],
  R: [
    [{ x: 730, y: 245 }, { x: 810, y: 220 }, { x: 890, y: 245 }],
    [{ x: 725, y: 335 }, { x: 820, y: 335 }, { x: 915, y: 335 }],
    [{ x: 730, y: 425 }, { x: 810, y: 450 }, { x: 890, y: 425 }],
  ],
  B: [
    [{ x: 330, y: 330 }, { x: 400, y: 315 }, { x: 465, y: 330 }],
    [{ x: 325, y: 405 }, { x: 400, y: 390 }, { x: 470, y: 405 }],
    [{ x: 340, y: 480 }, { x: 410, y: 505 }, { x: 465, y: 480 }],
  ],
  D: [
...
function drawOrbitLines() {
  const paths = [
    ["major", "M112 295 C150 70 850 70 888 295"],
    ["", "M124 342 C210 138 790 138 876 342"],
    ["inner", "M148 388 C255 208 745 208 852 388"],

    ["major", "M112 295 C-34 428 72 690 430 754"],
    ["", "M180 250 C28 410 118 638 456 698"],
    ["inner", "M258 250 C126 396 172 586 480 636"],

    ["major", "M888 295 C1034 428 928 690 570 754"],
    ["", "M820 250 C972 410 882 638 544 698"],
    ["inner", "M742 250 C874 396 828 586 520 636"],

    ["", "M108 338 C246 326 362 326 500 354 C638 326 754 326 892 338"],
    ["inner", "M205 430 C322 474 407 507 500 558 C593 507 678 474 795 430"],
    ["inner", "M314 407 C392 320 608 320 686 407 C608 492 392 492 314 407"],
  ];
